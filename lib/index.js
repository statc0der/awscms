(function(){
  var aws2js, handlebars, Sync, extname, sync, async, Template, Partial, Data, find, syncCb, Awscms, replace$ = ''.replace;
      ...
      return Sync(function fiber(){
        ...
        if (RegExp('^' + this$.prefix).exec(req.path)) {
          ...
          if ((that = Template.resolve(remotePath)) != null) {
            res.send(
            that.render(
            (ref$ = (ref1$ = Data.resolve(remotePath)) != null ? ref1$.data : void 8) != null
              ? ref$
              : {}));
            return true;
          }
