(function(){
  var aws2js, handlebars, Sync, extname, sync, async, future, Template, Partial, Data, GlobalData, find, tap, andNow, Awscms, replace$ = ''.replace;
      ...
      return Sync(function fiber(){
        ...
        if (RegExp('^' + this$.prefix).exec(req.path)) {
          ...
          if ((file = Template.resolve(remotePath)) != null) {
            console.log(GlobalData.collapse());
            res.send(
            file.render(
            (function(it){
