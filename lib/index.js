(function(){
  ...
  module.exports = Awscms = (function(){
    ...
    function Awscms(arg$){
      var accessKeyId, secretAccessKey, bucket, proxy, httpOptions, ref$, refreshInterval, that, this$ = this;
      accessKeyId = arg$.accessKeyId, secretAccessKey = arg$.secretAccessKey, bucket = arg$.bucket, this.prefix = arg$.prefix, this.external = arg$.external, proxy = arg$.proxy, httpOptions = (ref$ = arg$.httpOptions) != null
        ...
        : 1000 * 60 * 5;
      if ((that = proxy) != null) {
        httpOptions.agent = tunnel.httpOverHttp(that);
      }
      console.log('s3', accessKeyId, secretAccessKey, null, httpOptions);
